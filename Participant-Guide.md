...
1. [What is a Container?  What is Docker?](../master/Participant-Guide.md#what-is-a-container-what-is-docker)

2. [Verify Docker Engine Install](../master/Participant-Guide.md#verify-docker-engine-install)

3. [Run Your First Container](../master/Participant-Guide.md#run-your-first-container)

4. [Docker Images and Docker Hub](../master/Participant-Guide.md#docker-images-and-the-docker-hub)
...
> *Note - you can specify the exact hosts to run on when the Wordpress Stack is deployed [by using a host tag](https://community.oracle.com/community/cloud_computing/infrastructure-as-a-service-iaas/oracle-container-cloud-service/blog/2017/03/27/using-host-tags-to-specify-where-a-service-deploys).  This will automatically set the host constraint to host tag and no manual adjustment will be needed at deployment time. [See how this would look in the YAML](../master/images/tags.jpg)* 
